...
Important: I am not publishing the `sd_xl_base_0.9.safetensors` model. Please add your model link in `sdxl` then run the cell. There is an amazing website called https://dagshub.com where you can store your models for free. 😜 I think the model will soon be everywhere 😋
